...
class mdc(multiprocessing.Process):
    
    def __name__(s):
        'mdc modelo distribuicao condicional'
...
#        print(s.fT(h).pdf(t))
    ...
    def printContour(s,**kwargs):
        ...
        ax.text(0.05,temp,u'rho dados brutos = %.3f'%(pearsonr(H,T)[0]))
        temp -= 0.06
        ...
        if s.fTtype == 'weibull':
            ax.text(0.05,temp,u'Tflambw.coef %s:'%s.Tflambw.coeff)
            temp -= 0.06    
    ...
    def run(s):
        ...
        print('calculando s.mht = %.6f'%s.mht)
...
#
#mll = mdc()
#mll.fit(H,T,tipofH='lognormal',tipofT='lognormal',bins=20)
#
#mll.integral()
#
##%%
